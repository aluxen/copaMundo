 ...
 * @author rafae
 */
public class ManutencaoPessoas extends javax.swing.JFrame {

    /**
     * Creates new form ManutencaoPessoas
     */
    public ManutencaoPessoas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manutenção Pessoas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManutencaoPessoas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManutencaoPessoas().setVisible(true);
            }
        });
    }
